...
- Replace any generic colors in the design with these brand-specific colors`;
  ...
  // MASTER BRAND PROMPT: If available, this is the most important directive
  // It's generated by AI analysis of the brand's actual example posts
  if (brandColors?.master_brand_prompt) {
    prompt = `MASTER BRAND VISUAL GUIDE (HIGHEST PRIORITY - follow this exactly):
${brandColors.master_brand_prompt}

---
BASE IMAGE REQUEST:
${prompt}`;
    console.log('Background prompt enhanced with master brand prompt');
  }
